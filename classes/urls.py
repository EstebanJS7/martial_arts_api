...
urlpatterns = [
    ...
    path('reservations/my/', MyClassReservationsView.as_view(), name='class-reservations-my'),
    ...
    path('stats/cancellations/', CancellationAnalysisView.as_view(), name='class-cancellation-analysis'),
